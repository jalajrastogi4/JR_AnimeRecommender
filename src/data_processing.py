...
class DataProcessor:
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("Saved all training, testing and rating_df Data")
        except Exception as e:
    ...
    def process_anime_data(self):
        try:
            ...
            logger.error(f"Failed to save anime and anime_synopsis : {e}")
            raise CustomException("Failed to save anime and anime_synopsis", sys)
